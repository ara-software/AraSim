...
class Event {
  ...
  public:
      ...
      double event_ID; // event_ID of a single event i.e. all secondary interactions get the same event_ID as the first interaction
      double nu_prim_energy; // energy (in eV) of the primary neutrino associated with an interaction (all secondary interactions get the same nu_prim_energy
                                    // because they were all generated by the same primary neutrino)
      int prim_particle_type; // primary particle ID according to Particle Data Group     
