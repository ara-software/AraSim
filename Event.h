...
class Event {
  ...
  public:
      ...
      vector<double> nu_prim_energy; // energy of the primary neutrino associated with an interaction (all secondary interactions get the same nu_prim_energy
                                    // because they were all generated by the same primary neutrino)
      vector<int> prim_particle_type; // primary particle ID according to Particle Data Group     
