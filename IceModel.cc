...
if ( file.is_open() ) {
  ...
  //Average line, refer to http://ara.physics.wisc.edu/docs/0010/001034/001/AraSimBugFix_Systematics_update.pdf, p.23
  ...
  //if lower bound, then
  double ARA_IceAtten_Depth_tmp[53] =
  ...
  double ARA_IceAtten_Length_tmp[53] =
