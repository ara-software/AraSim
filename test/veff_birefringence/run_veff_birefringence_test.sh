...
./AraSim test/veff_birefringence/birefringence_setup 2 outputs/. 2>&1 | tee test/veff_birefringence/veff_birefringence_test_output.txt 

# then, do a comparison to check for consistency

EXPECTED_GLOBAL_PASS=3
EXPECTED_TOTAL_WEIGHT=0.992699
