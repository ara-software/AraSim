...
///////////////////////////////////////////
  ...
  TCanvas *c1 = new TCanvas("c1","A Simple Graph Example",3000,500);
  c1->Divide(6,1);
  ...
  if ( settings->DETECTOR != 0 ) {
    ...
    gr_antenna_H->SetMarkerSize(0.5);
    ...
    gr_crosssection->SetMarkerStyle(8);
    gr_crosssection->SetMarkerSize(0.5);
    gr_crosssection->Draw("aP");
    ...
    //-------------------------------------------------- 
    gr_posnu->SetMarkerStyle(8);
    gr_posnu->SetMarkerSize(0.3);
    gr_posnu->Draw("aP");
    ...
    gr_depth->SetMarkerSize(0.3);
    gr_depth->SetMarkerStyle(8);
    gr_depth->Draw("ap");
    
    gr_top->SetMarkerColor(3);
    gr_top->SetMarkerSize(0.3);
    gr_top->SetMarkerStyle(8);
    gr_top->Draw("p");
    
    gr_bot->SetMarkerColor(4);
    gr_bot->SetMarkerSize(0.3);
    gr_bot->SetMarkerStyle(8);
    gr_bot->Draw("p");
  ...
  c1->Print("ARA-37_station_layout.gif"); 
